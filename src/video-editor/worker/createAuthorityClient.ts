...
import {
	type CreateP2PAuthorityAdapterConfig,
	createP2PAuthorityAdapter,
} from "../p2p/P2PAuthorityAdapter";
import type {
	PageP2PManager,
	PageP2PManagerConfig,
	PageP2PManagerEvents,
} from "../p2p/PageP2PManager";
...
export interface AuthorityResourceBindings {
	...
	onServerResourceTransport?: (
		remotePeerId: string,
		transport: AuthorityRawTransportLike,
	) => void;
...
export const createAuthorityClient = (
	options: CreateAuthorityClientOptions = {},

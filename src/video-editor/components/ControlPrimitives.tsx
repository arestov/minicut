...
export const Button = ({
	...
	<button
		className={joinClassNames('ve-button', `ve-button--${variant}`, `ve-button--${size}`, className)}
		{...props}
	/>
)
...
export const IconButton = ({
	...
	<Button
		aria-label={label}
		title={title ?? label}
		className={joinClassNames('ve-icon-button', children ? 've-icon-button--with-label' : null, className)}
		size={size}
		{...props}
	>

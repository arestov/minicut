		...
		<div className="ve-inspector-tab-panel" role="tabpanel" aria-label="Edit inspector">
			...
			<InspectorSection title="Opacity" icon={Gauge}>
				<label className="ve-slider-field">
					<span>Opacity</span>
					<input type="range" min="0" max="100" step="10" value={opacityPercent} onChange={(event) => clipDispatch('updateOpacity', { opacityPercent: Number(event.currentTarget.value) })} />
				</label>
			...
			<InspectorSection title="Transform" icon={Move} ariaLabel="Transform controls">
				<TransformFields transform={transform} onChange={(patch) => clipDispatch('setTransform', patch)} />
			</InspectorSection>

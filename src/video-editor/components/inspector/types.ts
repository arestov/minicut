...
export const colorGradePresets: Array<{
	id: string;
	label: string;
	params: Partial<Record<PrimaryColorParam, number>>;
}> = [
	{
		id: "neutral",
		label: "Neutral",
		params: { exposure: 0, contrast: 1, saturation: 1, temperature: 0 },
	},
	{
		id: "warm",
		label: "Warm",
	...
	},
	{
		id: "punch",
		label: "Punch",
		params: { exposure: 0.08, contrast: 1.2, saturation: 1.35, temperature: 0 },
	},
];

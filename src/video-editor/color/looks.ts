export type LookParam = 'exposure' | 'contrast' | 'saturation' | 'hue' | 'gamma'
...
export const lookPresets: LookPreset[] = [
	...
	},
	{
		...
		params: { exposure: -0.04, contrast: 1.18, saturation: 0.94, hue: -4, gamma: 0.98 },
	},
	{
		id: 'golden',
		label: 'Golden',
		...
		params: { exposure: 0.08, contrast: 1.08, saturation: 1.18, hue: 5, gamma: 1 },
	},
	{
		id: 'cool',
		label: 'Cool',
		...
		params: { exposure: 0.02, contrast: 1.1, saturation: 0.9, hue: -12, gamma: 1 },
	},
	{
		id: 'mono',
		label: 'Mono',
		...
		params: { exposure: 0, contrast: 1.22, saturation: 0, hue: 0, gamma: 1.02 },
	},
]

...
import { createPaletteFromHex, createPaletteFromRgbSamples } from './framePalette'
...
describe('frame palette suggestions', () => {
	it('generates a readable text/background pair from RGB samples', () => {
		...
		expect(getContrastRatio(palette!.textColor, palette!.backgroundColor)).toBeGreaterThanOrEqual(4.5)
	})

...
export const compilePreviewLayerOperation = (clip: RenderedClip): PreviewLayerOperation => ({
	clipId: clip.id,
...
export const compilePreviewRenderPlan = (frame: PreviewFrame): PreviewRenderPlan => {

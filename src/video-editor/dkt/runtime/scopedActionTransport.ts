...
export const createSyncUpdateStructureUsageMessage = (data: unknown): MiniCutDktTransportMessage => ({
  type: DKT_MSG.SYNC_UPDATE_STRUCTURE_USAGE,
  data,
})

export const createSyncRequireShapeMessage = (data: unknown): MiniCutDktTransportMessage => ({

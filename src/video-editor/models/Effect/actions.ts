...
export type DktEffectActionName =
	| "setEffectName"
	| "setEffectKind"
	| "setEffectEnabled"
	| "setEffectAmount"
...
export const reduceEffectNameAction = (
	payload: unknown,
): Pick<EffectAttrs, "name"> | null => {
	const name =
...
export const reduceEffectKindAction = (
	payload: unknown,
): Pick<EffectAttrs, "kind"> | null => {
...
export const reduceEffectEnabledAction = (
	payload: unknown,
): Pick<EffectAttrs, "enabled"> | null => {
	const enabled =
...
export const reduceEffectAmountAction = (
	payload: unknown,
): Pick<EffectAttrs, "amount"> | null => {
...
export const reduceEffectParamsAction = (
	payload: unknown,
): Pick<EffectAttrs, "params"> | null => {
	const params = (payload as { params?: unknown } | null)?.params ?? payload;
	return params && typeof params === "object"
		? { params: params as EffectAttrs["params"] }
		: null;
};

export const reduceEffectColorAction = (
	payload: unknown,
): Pick<EffectAttrs, "color"> | null => {
	const color = (payload as { color?: unknown } | null)?.color ?? payload;
	return color && typeof color === "object"
		? { color: color as EffectAttrs["color"] }
		: null;
};

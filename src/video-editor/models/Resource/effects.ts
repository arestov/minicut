...
export const RESOURCE_TRANSFER_STATUS_FX =
	"$fx_resourceTransferStatus" as const;
...
export const isResourceTransferStatusEffectData = (
	value: unknown,
): value is ResourceTransferStatusEffectData => {

...
export const isProjectImportFilesEffectData = (
	value: unknown,
): value is ProjectImportFilesEffectData => {
	const data = value as Partial<ProjectImportFilesEffectData> | null;
	return Boolean(
		data &&
			typeof data.projectId === "string" &&
			typeof data.inputBatchHandleId === "string",
	);
};
...
export const createProjectRenderExportEffectData = (
	data: ProjectRenderExportEffectData,
): ProjectRenderExportEffectData => data;
